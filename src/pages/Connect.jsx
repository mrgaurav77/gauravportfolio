...
function Connect(){
    return(
        ...
        <div className="home-container">
            <h2>Have a project or an idea? Let's Connect over a zoom call!</h2>
            ...
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ut, similique.</p>
            ...
            <div className='connect-flex'>
                <a href="https://api.whatsapp.com/send?phone=919511602531" target="block" className="connect chat-wp" ><span><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
...
</svg></span><span>let's chat on WhatsApp</span></a>
            </div>
        </div>
        </>
    )
