    ...
    <>
      <nav className="navbar">
        <div className='nav-links'>
          ...
          <button className={theme == 'light'? "theme": "theme-dark"} onClick={themeHandler}>{theme == "light"? 
            ...
            </svg> : <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-moon-stars-fill" viewBox="0 0 16 16">
